...
Literal ***REMOVED*** = (Literal)value;
IRI datatype = ***REMOVED***.getDatatype();
if (datatype==null) datatype = vf.createIRI(STRING);
log.debug("\tNew: "+***REMOVED***+" @ "+datatype);

Object o = converter.convertToType(***REMOVED***.stringValue(), datatype.toString());
...
Literal ***REMOVED*** = (Literal) value;
IRI datatype = ***REMOVED***.getDatatype();
Object o = converter.convertToType(***REMOVED***.stringValue(), datatype == null ? null : datatype.toString());
log.debug("\t" + local + " == " + ***REMOVED*** + " -> " + o + " = " + o.getClass() + " @ " + datatype);
