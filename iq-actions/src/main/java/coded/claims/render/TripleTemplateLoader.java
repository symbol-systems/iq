...
public class TripleTemplateLoader extends AbstractTemplateLoader {
    ...
    public TemplateSource sourceAt(String location) {
        ...
        Set<Literal> literals = TripleFinder.valuesOf(kb.getTriples(), templateIRI, followPredicate, kb.getIdentity());
        // log.trace("template.triples.sourceAt: "+templateIRI+" -> "+literals+" @ "+templateMimeType);
