...
public class IERC20 extends Contract {
    ...
    public RemoteFunctionCall<Boolean> transfer(String recipient, BigInteger amount) {
    ...
    public RemoteFunctionCall<Boolean> transferFrom(String sender, String recipient, BigInteger amount) {
