...
return model.embed(segment).content();
	...
	public static InMemoryEmbeddingStore<TextSegment> defaultEmbeddingStore() {
		return new InMemoryEmbeddingStore<>();
	}

	public EmbeddingStore<TextSegment> load() {
	...
	public EmbeddingStore<TextSegment> load(File storeHome) {
		log.info("finder.text.load: {} -> {}", storeHome.exists(), storeHome);
		if (!storeHome.exists()) {
			this.store = defaultEmbeddingStore();
			save(storeHome);
		}
