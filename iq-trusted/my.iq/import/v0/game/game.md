...
### An ai:U involves a pair of tropes 

ai:LoveLoss iq:needs ai:U.
ai:LoveHate iq:needs ai:U.
ai:HeroSuccess iq:needs ai:U.
ai:AntiHeroSuccess iq:needs ai:U.
ai:SuccessFailure iq:needs ai:U.
ai:CharacterStory iq:needs ai:U.
ai:PlotTwist iq:needs ai:U.
ai:ConflictResolution iq:needs ai:U.
ai:ResolutionSacrifice iq:needs ai:U.
ai:ConflictSacrifice iq:needs ai:U.
ai:DramaNews iq:needs ai:U.
ai:NewsNarrator iq:needs ai:U.
ai:DeceitBetrayal iq:needs ai:U.
ai:PlotDeceit iq:needs ai:U.
ai:PlotTruth iq:needs ai:U.
ai:CharacterSuccess iq:needs ai:U.
ai:McGuffin iq:needs ai:U.
...
ai:Plot iq:needs ai:Tropes, ai:Narrator, ai:U, ai:Actor, ai:Plot, ai:Twist, ai:Hero, ai:AntiHero, ai:Antagonist, ai:Oops, ai:Trust.
...
# Hero needs
ai:Hero iq:needs ai:Tropes, ai:Narrator, ai:U, ai:Actor, ai:Plot, ai:Twist, ai:Trust.

# AntiHero needs
ai:AntiHero iq:needs ai:Tropes, ai:Narrator, ai:U, ai:Actor, ai:Plot, ai:Twist, ai:Trust.

# Antagonist needs
ai:Antagonist iq:needs ai:Tropes, ai:Narrator, ai:U, ai:Actor, ai:Plot, ai:Twist, ai:Trust.

# Protagonist needs
ai:Protagonist iq:needs ai:Tropes, ai:Narrator, ai:U, ai:Actor, ai:Plot, ai:Twist, ai:Trust.
