...
public class OAUTH implements I_Intent {
    DefaultLinkedInClient client;
    OrganizationConnection organizationConnection;
    ShareConnection shareConnection;
    String clientId, redirectURI, state;

    protected LinkedIn(String clientId, String redirectURI) {
        this.clientId = clientId;
        this.redirectURI = redirectURI;
    }

    public LinkedIn(String accessToken) throws GeneralSecurityException, IOException {
        login(accessToken);
    }

    private LinkedIn login(String accessToken) throws GeneralSecurityException, IOException {
    ...
    public LinkedIn login(String clientSecret, String code) throws GeneralSecurityException, IOException {
        this.clientId = clientId;
        this.redirectURI = redirectURI;
