 ...
 * increment
 * the index of String t we are comparing, d is copied to p, the second int[].
 * Doing so
 * allows us to retain the previous cost counts as required by the algorithm
 * (taking
 * the minimum of the cost count to the left, up one, and diagonally up and to
 * the left
 * of the current cost count being calculated). (Note that the arrays aren't
 * really
 * copied anymore, just switched...this is clearly much better than cloning an
 * array
