...
6. Add query/argument validation and guard against SPARQL injection
   - Ensure all GraphQL arguments are bound via prepared query bindings (you have helpers in `SPARQLMapper.setBindings`) and validate expected types (IRIs vs literals).
