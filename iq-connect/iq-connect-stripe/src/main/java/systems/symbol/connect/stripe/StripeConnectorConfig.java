...
public final class StripeConnectorConfig {

private final String apiKey;
private final Duration pollInterval;
private final String graphIri;

public StripeConnectorConfig(String apiKey, Duration pollInterval, String graphIri) {
this.apiKey = apiKey;
...
public static StripeConnectorConfig fromEnv() {
String apiKey = System.getenv("STRIPE_API_KEY");
String graphIri = System.getenv("STRIPE_GRAPH_IRI");
Duration poll = Duration.ofMinutes(5);
String interval = System.getenv("STRIPE_POLL_INTERVAL_SECONDS");
if (interval != null && !interval.isBlank()) {
try { poll = Duration.ofSeconds(Long.parseLong(interval)); } catch (NumberFormatException ignored) { }
}
return new StripeConnectorConfig(apiKey, poll, graphIri);
}
}
