...
public final class StripeConnectorKernel implements I_ConnectorKernel {

private final StripeConnector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public StripeConnectorKernel(StripeConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "stripe-connector-kernel"));
}
