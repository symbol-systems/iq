...
public final class SalesforceConnectorKernel implements I_ConnectorKernel {
...
public SalesforceConnectorKernel(SalesforceConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "salesforce-connector-kernel"));
}
