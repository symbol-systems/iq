...
public final class DatabricksConnectorKernel implements I_ConnectorKernel {

private final DatabricksConnector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public DatabricksConnectorKernel(DatabricksConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "databricks-connector-kernel"));
}
