...
public final class GoogleAppsConnectorKernel implements I_ConnectorKernel {

private final GoogleAppsConnector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public GoogleAppsConnectorKernel(GoogleAppsConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "googleapps-connector-kernel"));
}
