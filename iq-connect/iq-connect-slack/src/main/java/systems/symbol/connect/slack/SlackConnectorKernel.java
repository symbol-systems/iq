...
public final class SlackConnectorKernel implements I_ConnectorKernel {

private final SlackConnector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public SlackConnectorKernel(SlackConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "slack-connector-kernel"));
}
