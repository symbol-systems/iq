...
public final class SnowflakeConnectorKernel implements I_ConnectorKernel {

private final SnowflakeConnector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public SnowflakeConnectorKernel(SnowflakeConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "snowflake-connector-kernel"));
}
