...
public final class DatadogConnectorKernel implements I_ConnectorKernel {

private final DatadogConnector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public DatadogConnectorKernel(DatadogConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "datadog-connector-kernel"));
}
