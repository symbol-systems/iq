...
public final class DigitaloceanConnectorKernel implements I_ConnectorKernel {

private final DigitaloceanConnector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public DigitaloceanConnectorKernel(DigitaloceanConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "digitalocean-connector-kernel"));
}
