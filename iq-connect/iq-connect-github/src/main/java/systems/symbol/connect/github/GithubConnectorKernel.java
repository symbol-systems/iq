...
public final class GithubConnectorKernel implements I_ConnectorKernel {
...
public GithubConnectorKernel(GithubConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "github-connector-kernel"));
}
