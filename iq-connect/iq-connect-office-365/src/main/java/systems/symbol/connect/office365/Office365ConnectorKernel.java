...
public final class Office365ConnectorKernel implements I_ConnectorKernel {

private final Office365Connector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public Office365ConnectorKernel(Office365Connector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "office365-connector-kernel"));
}
