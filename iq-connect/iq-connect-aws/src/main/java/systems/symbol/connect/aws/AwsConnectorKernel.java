...
public final class AwsConnectorKernel implements I_ConnectorKernel {
...
public AwsConnectorKernel(AwsConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "aws-connector-kernel"));
}
