...
public final class GcpConnectorKernel implements I_ConnectorKernel {

private final GcpConnector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public GcpConnectorKernel(GcpConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "gcp-connector-kernel"));
}
