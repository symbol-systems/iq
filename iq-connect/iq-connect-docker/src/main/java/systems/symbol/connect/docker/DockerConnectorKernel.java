...
public final class DockerConnectorKernel implements I_ConnectorKernel {

private final DockerConnector connector;
private final ScheduledExecutorService executor;
private final AtomicBoolean started = new AtomicBoolean(false);
private ScheduledFuture<?> scheduledTask;

public DockerConnectorKernel(DockerConnector connector) {
this.connector = connector;
this.executor = Executors.newSingleThreadScheduledExecutor(r -> new Thread(r, "docker-connector-kernel"));
}
