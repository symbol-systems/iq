...
**Decision:** Use SPARQL query templates with predefined variable placeholders (e.g., `?id`) and bind values via repository query APIs rather than concatenating ***REMOVED***s.
