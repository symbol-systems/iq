...
//	private static final Logger log = LoggerFactory.getLogger(BakeIRI.class);
	...
	public Value evaluate(ValueFactory valueFactory, Value... args) throws ValueExprEvaluationException {
		if (args.length < 2)  throw new ValueExprEvaluationException("Bake(prefix,args...) requires a mandatory prefix and at least one value");
	...
	public String sha256(Value... args) {
		...
		for(int i=1;i<args.length;i++) concat.append(args[i].stringValue());
