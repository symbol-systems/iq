...
//        return script!=null?script:null;
     ...
     * @param query      The IRI representing the SPARQL query.
     * @param context    The IRI representing the context in which the query should be executed.
     * @return The SPARQL query as a string.
     */
     ...
     * @param context    The IRI representing the context in which the script should be executed.
     ...
     * @param mimetype   The MIME type associated with the script.
     * @param context    The IRI representing the context in which the script should be executed. NUll matches any.
