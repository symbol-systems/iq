...
public class RDFLoader {
    ...
    public Literal content(IRI assetIRI, InputStream inStream, IRI mimeType)
    ...
    public Literal content(IRI assetIRI, String content, IRI mimeType)
            throws IOException, RDFParseException, RepositoryException {
        if (mimeType == null)
            mimeType = Values.iri("text/plain");
    ...
    public void load(RepositoryConnection conn, IRI assetIRI, InputStream tripleStream, RDFFormat format)
            throws IOException {
