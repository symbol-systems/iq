...
public class Remodel {
    private static final Logger log = LoggerFactory.getLogger(Remodel.class);
    static DynamicModelFactory dmf = new DynamicModelFactory();

    public static IRI mimetypeForPath(String path) {
        String mime = FileFormats.toPlainTextMimetype(path);
        if (mime == null)
            return null;
        return mimetype(mime);
    }

    public static IRI mimetype(String shortType) {
        return iri(COMMONS.MIME_TYPE + shortType);
    }
