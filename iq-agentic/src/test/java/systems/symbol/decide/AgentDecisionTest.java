...
import systems.symbol.agent.AgentTestBed;
...
import static systems.symbol.agent.AgentTestBed.*;
...
class AgentDecisionTest {
    ...
    @Test
    void testDecision() throws StateException {
        ...
        // review --> complete
        AgentDecision human = new AgentDecision(agent);
        assert human.agent == agent;
        human.decide(complete);
        assert human.decision.intent() == complete;
