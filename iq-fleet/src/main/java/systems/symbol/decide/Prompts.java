...
public class Prompts {
    ...
    public static I_Thread<String> decision(I_Thread<String> thread, Model model, IRI self, I_StateMachine<Resource> fsm, Bindings my) throws IOException {
        ...
        if (!transitions.isEmpty()) {
            ...
            log.info("prompt.intents: {}", intentsPrompt);
