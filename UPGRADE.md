...
6. **Idiomatic interfaces.** New public APIs extend existing `I_*` interfaces from `iq-abstract` or `iq-kernel`; do not introduce a fourth parallel exception hierarchy.
...
*Generated by architecture audit — March 2026.*
