...
public class InMemoryServerRuntimeManager implements ServerRuntimeManager {

    private static final Logger log = LoggerFactory.getLogger(InMemoryServerRuntimeManager.class);

    private final ConcurrentMap<String, RuntimeState> runtimes = new ConcurrentHashMap<>();

    public InMemoryServerRuntimeManager() {
