 ...
 * @param actorThe IRI representing the agent or entity that performed the generation.
 ...
 *
 * @param modelThe RDF model to which the custom attribute will be added.
 ...
 * @param valueThe value of the custom attribute.
 */
