...
public static byte[] encrypt(InputStream certStream, InputStream keyStream, String message)
...
public static byte[] encrypt(Cipher cipher, InputStream keyStream, String message)
throws NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException, CertificateException,
IOException, InvalidKeySpecException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
...
public static PrivateKey loadPrivateKey(InputStream keyStream)
...
public static byte[] decrypt(InputStream keyStream, byte[] ciphertextBytes)
throws NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException, CertificateException,
IOException, InvalidKeySpecException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
Cipher cipher = Locksmith.cipher();
...
public static void check(InputStream keyStream, InputStream certStream, String message)
...
// public PrivateKey loadPrivateKey(InputStream privateKeyIn) throws
