...
protected String md_blocks_***REMOVED*** = "```(?:([a-zA-Z0-9_]+))?\\n([\\s\\S]*?)\\n```";
...
// markdown blocks
Pattern pattern = Pattern.compile(md_blocks_***REMOVED***);
