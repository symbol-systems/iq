...
public static void bootstrap(RealmManager realms) throws Exception, PlatformException {
...
public static void bootstrap(RealmManager realms, File[] files) throws Exception, PlatformException {
if (files != null) {
for (File file : files) {
...
public static void boot(I_Realm realm, File file) throws IOException {
...
public static void index(I_Realms realms) throws SecretsException, PlatformException {
