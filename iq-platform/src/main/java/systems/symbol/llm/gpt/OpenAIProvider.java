...
public class OpenAIProvider implements I_LLMProvider {
...
wrapper.tool(systems.symbol.llm.tools.Tool.defineFunction("openai.chat", "Invoke OpenAI chat completion").
