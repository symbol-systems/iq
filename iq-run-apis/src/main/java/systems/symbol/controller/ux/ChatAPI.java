...
public class ChatAPI extends GuardedAPI {
    ...
    public Response chat(@PathParam("repo") String repo, @PathParam("actor") String actor, @HeaderParam("Authorization") String auth,
                               Conversation chat) throws APIException, IOException {
